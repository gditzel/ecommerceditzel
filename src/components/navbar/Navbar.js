...
export function Navbar() {
  return (
    <Disclosure as="nav" className="bg-green-800 fixed right-0 left-0 z-10">
      {({ open }) => (
        <>
            ...
            <div className="relative flex items-center justify-between h-24">
              ...
              <div className="flex-1 flex items-center justify-center sm: sm:justify-start">
                ...
                <div className="hidden sm:block sm:ml-6">
                  <ul className="flex space-x-4">
                    <li >
                      <Link to="/Productos" className='text-green-300 hover:bg-green-700 hover:text-white px-3 py-2 rounded-md text-2xl font-medium'>Productos</Link>
                    </li>

                    <li>
                      <Link to="/" className='text-green-300 hover:bg-green-700 hover:text-white px-3 py-2 rounded-md text-2xl font-medium'><BtnDropdown></BtnDropdown></Link>
                    </li>

                    <li>
                      <Link to="/PcArmada" className='text-green-300 hover:bg-green-700 hover:text-white px-3 py-2 rounded-md text-2xl font-medium'>PC armadas</Link>
                    </li>
              ...
              <div class="xl:w-96">
                <div class="input-group relative flex items-stretch">
                  <input type="search" class="form-control mr-3 relative flex-auto min-w-0 block w-full px-3 py-1.5 text-base font-normal text-green-700 bg-white bg-clip-padding border border-solid border-green-300 rounded transition ease-in-out m-0 focus:text-green-700 focus:bg-white focus:border-green-600 focus:outline-none" placeholder="Buscar productos o marcas" aria-label="Search" aria-describedby="button-addon2"/>
